...
'“Offer the lazy an egg, and they’ll want you to peel it for them.” – Unknown',
//Quotes for lazy 11-20
...
//Quotes for lazy 31-40
'“Kill the darlings in your life. Laziness, wishful thinking, procrastination, kill them.” – Bangambiki Habyarimana',
...
'“Sometimes, being lazy is much favorable than labouring without a purpose.” – Vishal Ostwal',
...
//Quotes for the lazy 41-50
'“The lazy man is usually an ideal man, for he lives on theory, sleeps on hope, and dies in despair.” – J. W Croker',
'“A lazy man would have every day a holiday.” – Ahmed Vesik',
...
const procrastQuotes = [//Anti-procrastination quotes 1-10 from https://web.archive.org/web/20200919085159/https://www.keepinspiring.me/procrastination-quotes/
...
'“Never put off tomorrow what may be done day after tomorrow just as well.” – Mark Twain',
...
//Anti-procrastination quotes 11-20
...
//Anti-procrastination quotes 21-30
...
//Anti-procrastination quotes 31-40
...
//Anti-procrastination quotes 41-50
...
//Anti-procrastination quotes 51-60
...
//Anti-procrastination quotes 61-70
...
//Anti-procrastination quotes 71-80
...
function parseQuote(str) {
  ...
  // If not matching, treat as custom quote with no author
  return { quote: str, author: "" };
}

const lazQuotesParsed = lazQuotes.map(parseQuote);
const motQuotesParsed = motQuotes.map(parseQuote);
const procrastQuotesParsed = procrastQuotes.map(parseQuote);

const quotes = lazQuotesParsed.concat(motQuotesParsed, procrastQuotesParsed);
